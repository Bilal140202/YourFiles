...
class ReadFileWorker(private val context: Context, workerParameters: WorkerParameters) :
    ...
    override suspend fun doWork(): Result {
        ...
        if (pathsToScan.isEmpty()) {
            Log.e("YourFiles", "No storage paths found to scan.")
        ...
        Log.d("YourFiles", "Total files to scan: $totalFiles")
        ...
        pathsToScan.forEach { path ->
            Log.d("YourFiles", "Starting scan on path: $path")
        ...
        Log.d("YourFiles", "Time for filling DB $timeTaken")
